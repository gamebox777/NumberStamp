...
| ツールバー | 機能 |
| :---: | :--- |
| <img src="docs/images/toolbar.png" height="300" alt="ツールバー"> | **上から順に:**<br>👆 **選択 (Select)**: オブジェクトの選択・移動 <br>🔢 **スタンプ (Stamp)**: 連番スタンプ配置 <br>🔲 **矩形 (Rectangle)**: 枠線描画 <br>⬇️ **画像保存**: PNG形式で保存 <br>💾 **プロジェクト保存**: JSON形式で保存 <br>📂 **プロジェクト読込**: JSON読込 <br>❌ **全削除**: キャンバス初期化 |
...
- **2026-02-17**: バナー画像の周囲に枠線を追加
- **2026-02-17**: 設定パネルのバナー画像を更新（バージョン表示は維持）
